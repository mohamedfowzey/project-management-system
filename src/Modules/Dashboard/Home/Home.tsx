...
import {
  getTasksCount as getTasksCountApi,
  type ITasksCountResponse,
...
const StatCard = ({
  ...
  return (
    <div
      className={`${bgColor} rounded-xl shadow-sm p-4 flex flex-col justify-between `}
    >
    ...
    datasets: [
      {
        ...
        backgroundColor: ["#DDD6FF", "#FEFCE8", "#FAE8FF"],
        borderWidth: 2,
        borderColor: ["#C4B4FF", "#FFF085", "#F6CFFF"],
      },
    ],
  };
  const chartOptions = {
    ...
    datasets: [
      {
        ...
        backgroundColor: ["#FAE8FF", "#FEFCE8"],
        borderWidth: 2,
        borderColor: ["#F6CFFF", "#FFF085"],
      },
    ],
  };
    ...
    <>
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          ...
          <div
            className={` ${mood === "light" ? "bg-white" : "bg-gray-800"} rounded-xl shadow-md overflow-hidden p-6 flex flex-col justify-between`}
          >
            <div className="mb-6 ps-4 border-s-4 border-solid border-amber-500">
              <h2 className="text-xl font-semibold">Tasks</h2>
              <p
                className={` ${mood === "light" ? "text-gray-600" : "text-gray-400"} text-sm`}
              >
            ...
            >
              ...
              <p className="text-lg font-medium">{usersCount.activatedEmployeeCount} </p>
                ...
                <StatCard
                  ...
                  icon={ShieldCheck}
                  title="Active"
                  count={usersCount.activatedEmployeeCount}
                  bgColor="bg-fuchsia-100"
                  iconBgColor="bg-fuchsia-200"
                />
                ...
                <StatCard
                  ...
                  icon={ShieldOff}
                  title="Inactive"
                  count={usersCount.deactivatedEmployeeCount}
                  bgColor="bg-yellow-50"
                  iconBgColor="bg-yellow-200"
                />
              </div>
