...
export default function Projects() {
  ...
  return (
    ...
    <div className="flex justify-between items-center mt-2 mb-10 py-4 px-2 md:px-9.5 bg-white dark:bg-gray-950 ">
        <h1>Tasks</h1>
        <div className="shrink mt-[-1rem]" onClick={()=>navigate('/dashboard/add-task')}>
              ...
              <tbody>
                {
                  filteredProjects.map((project) => (
                    <tr key={project?.id} className="table-row">
                      ...
                      <td className=" dark:text-black ">{project?.description}</td>
                      <td>
                        ...
                        <div className="actions-wrapper">
                          ...
                          {openMenu === project.id && (
                            <div className="actions-menu">
                              ...
                              <button className="action-btn edit-btn  dark:text-black" onClick={()=>navigate(`/dashboard/edit-task/${project?.id}`)}>
                                <FilePenLine
                                  color="var(--bg-main-color)"
                                  size={20}
                                  strokeWidth={1.5}
