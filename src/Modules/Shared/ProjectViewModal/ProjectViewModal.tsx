        ...
        {isOpen && (
          ...
          >
            <div
              ...
              className="w-[95%] md:w-[70%] lg:w-[50%] bg-white dark:bg-gray-800 dark:text-white rounded-2xl shadow-xl p-8 relative transition-all duration-300 scale-100  "
            >
              <button
                onClick={() => setIsOpen(false)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 border-t border-b border-gray-100 dark:border-gray-700 py-4 mb-2">
                ...
                <div className="space-y-1">
                  ...
                  <OnlyUsers>
                    ...
                    {project?.task && project.task.length > 0 && project.task.map((utask, index) => (
                      ...
                      <div key={utask?.id || index} className=" w-60 grid grid-cols-2 items-center gap-1 pb-0.5 border-b border-gray-100 dark:border-gray-800 last:border-0">
